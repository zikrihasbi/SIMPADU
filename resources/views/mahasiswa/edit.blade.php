                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ url('mahasiswa/' . $mahasiswa->nim) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="password" class="form-label">Password (isi untuk mengganti)</label>
                                ...
                                <div class="form-group">
                                    <label form="" class="form-label">Prodi</label>
                                ...
                                <div class="form-group">
                                    <label for="foto" class="form-label">Upload Foto (biarkan kosong jika tidak diganti)</label>
                                    ...
                                    @enderror
                                    @if ($mahasiswa->foto)
                                        <small class="text-muted">Foto saat ini: {{ $mahasiswa->foto }}</small>
                                    @endif
                                </div>
